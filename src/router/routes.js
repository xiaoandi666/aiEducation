...
import common from "lamejs/src/js/common";
import GradedTaskResult from "@/pages/Student/GradedTaskResult/index.vue";
...
export default [
  ...
  {
    path: "/teacherClass/:taskId/marking/:taskId",
    component: () => import("@/components/marking/index.vue"),
  },
  {
    path: "/course/word/:stuId/:taskId",
    component: () => import("@/pages/TeacherClass/score/index.vue"),
  },
  {
    name: "student",
    path: "/student",
  ...
  {
    path: "/gradedTaskResult/:taskId",
    component: GradedTaskResult,
  },
];
